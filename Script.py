...
ᴍᴀɪɴᴛᴀɪɴᴇᴅ ᴀɴᴅ ᴅᴇᴠʟᴏᴘᴇᴅ ʙʏ : <a href=https://t.me/MrReconic>Mʀ. ʀᴇᴄᴏɴɪᴄ</b>"""
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b><a href="https://t.me/CastleMoviesIndia">{file_name}</a></b>\n\n<b>⚡ ᴘᴏᴡᴇʀᴅ ʙʏ : <a href=https://t.me/+1Gj3GUMbPko5ZmU1>[Cᴀsᴛʟᴇ Mᴏᴠɪᴇs 🦁]</a></b>"""
...
📆 Rᴇʟᴇᴀsᴇ Iɴꜰᴏ : <a href={url}/releaseinfo>{year}</a>

🌟 Rᴀᴛɪɴɢ : <a href={url}/ratings>{rating}</a> / 10 (based on {votes} users ratings.)

📀 Rᴜɴᴛɪᴍᴇ : {runtime} Minutes

⏰ Rᴇsᴜʟᴛ sʜᴏᴡᴇᴅ ɪɴ : {remaining_seconds} <i>seconds</i> 🔥

❤ Rᴇᴏ̨ᴜᴇsᴛᴇᴅ ʙʏ : {message.from_user.mention}</b>"""
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/MrReconic'>ᴏᴡɴᴇʀ</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
🏆 ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴀ ɴᴇᴡ ᴘʟᴀɴ ᴀᴘᴀʀᴛ ꜰʀᴏᴍ ᴛʜᴇ ɢɪᴠᴇɴ ᴘʟᴀɴ, ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀʟᴋ ᴛᴏ ᴏᴜʀ <a href='https://t.me/MrReconic'>ᴏᴡɴᴇʀ</a> ᴅɪʀᴇᴄᴛʟʏ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ᴛʜᴇ ᴄᴏɴᴛᴀᴄᴛ ʙᴜᴛᴛᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ.
