...
PICS = (environ.get('PICS', 'https://envs.sh/OA0.jpg https://envs.sh/OAS.jpg https://envs.sh/OAW.jpg https://envs.sh/OAn.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7265713248').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002346797830').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002282453719'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002282453719'))  # Bin channel id (make sure bot is admin)
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002395472812'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002282453719'))  # Premium logs channel id
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1004682802831')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002471723804')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002408910299').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002395472812 -1002408910299 -1002383990532').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/axg.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'paytobishal@fam')

# ============================
# MongoDB Configuration
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://verac83790:PeZhHq0Q9113X3Us@castle-screen.qovxx.mongodb.net/?retryWrites=true&w=majority&appName=castle-screen")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://verac83790:NJHDvcHx7wGwubE2@cluster0.csswo.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+QlnIZUReBZJiNjY9')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+1Gj3GUMbPko5ZmU1')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/MrReconic')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/GlobalMoviesUpdates')
OWNERID = int(os.environ.get('OWNERID', '7265713248'))  # Replace with the actual admin ID
...
MSG_ALRT = environ.get('MSG_ALRT', '𝘊𝘢𝘴𝘵𝘭𝘦 𝘔𝘰𝘷𝘪𝘦𝘴 ⚡')
